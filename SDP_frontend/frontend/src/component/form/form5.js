    ...
    <h2>{this.state.eventname}</h2>
        <h4>Participant 1 Details: </h4>
              ...
              onChange={this.onChangePart1lname} />
				...
				<div className="form-row-total">
					<div className="form-row">
                        <input type="email" name="email1" className="input-text" placeholder="Email"  required pattern="[^@]+@[^@]+.[a-zA-Z]{2,6}" required  
                            value={this.state.part1email }   onChange={this.onChangePart1email}/>
					</div>
					<div className="form-row">
