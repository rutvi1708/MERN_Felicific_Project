...
import pic from "../img/music4.jpg";
        ...
        return (
               <div className="container-flex" style={{marginTop: '100px'}}>
                ...
                <div className="row sans m-2 m-md-2 text-cnt pb-2">									
                  <div className="col-5"><legend className="cn" style={{fontSize: '3em'}}>11</legend>March</div>								
                  <div className="col-2"><p style={{transform:'translateY(0.8em)',fontSize: '1.5em'}}>&amp;</p></div>									
                  <div className="col-5"><legend className="cn" style={{fontSize: '3em'}}>12</legend>March</div>								
                </div>	
